...
Java_com_motorolasolutions_msismartreply_SmartReplyClient_loadJNI(
...
JNICALL
Java_com_motorolasolutions_msismartreply_SmartReplyClient_predictJNI(
...
Java_com_motorolasolutions_msismartreply_SmartReplyClient_unloadJNI(
        JNIEnv
* env,
jobject thiz, jlong
storage_ptr) {
